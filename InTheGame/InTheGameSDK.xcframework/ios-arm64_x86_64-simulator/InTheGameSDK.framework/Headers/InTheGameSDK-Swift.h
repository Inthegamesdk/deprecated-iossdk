...
#ifndef INTHEGAMESDK_SWIFT_H
#define INTHEGAMESDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="InTheGameSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12InTheGameSDK14ITGOverlayView")
...
@interface ITGPlayerView : UIView <UIGestureRecognizerDelegate, WKNavigationDelegate, WKUIDelegate>
- (void)awakeFromNib;
- (void)layoutSubviews;
...
SWIFT_CLASS("_TtC12InTheGameSDK23ITGPlayerViewController")
